...
parent_selection_method = 'roulette'  # possible options: 'random', 'fast', 'tournament', 'truncation', 'roulette'
...
crossover_method = 'uniform'  # possible options: 'one_point', 'uniform', 'pmx', 'random'
