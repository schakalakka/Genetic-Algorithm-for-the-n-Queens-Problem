...
selection_method = 'roulette'  # possible options: 'random', 'fast', 'tournament', 'truncation', 'roulette'
...
crossover_method = 'order_based'  # possible options: 'order_based', 'pmx', 'random'
crossover_probability = 0.8  # usually between 0.6 and 1
crossover_method_list = ['pmx', 'order_based']  # for random crossover_method, therefore without 'random'
